...
flowchart LR
    ...
    subgraph Adapters["Concrete Adapters"]
        ...
        IndexStore["storage/sqlite_vec.py"]
    ...
    class IngestPkg,NvidiaAdapter,IndexStore,RuntimeEvidenceStore adapter
...
flowchart TB
    ...
    subgraph Ingest["Corpus to Index"]
        ...
        EmbedDocs --> Index["Local SQLite vector index"]
    end
